...
const Contratos = () => {
  ...
  // ContractList is intentionally defined OUTSIDE the component (see below)
  // to avoid being re-created on every render, which would remount every
  // ContractCard and thrash Dialog/Presence refs.
